...
// ProjectMemberServiceHandler is an autogenerated mock type for the ProjectMemberServiceHandler type
type ProjectMemberServiceHandler struct {
	mock.Mock
}

// Create provides a mock function with given fields: _a0, _a1
func (_m *ProjectMemberServiceHandler) Create(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectMemberCreateRequest]) (*connect.Response[apiv1.ProjectMemberResponse], error) {
...
func (_m *ProjectMemberServiceHandler) Delete(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectMemberDeleteRequest]) (*connect.Response[apiv1.ProjectMemberResponse], error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *ProjectMemberServiceHandler) Find(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectMemberFindRequest]) (*connect.Response[apiv1.ProjectMemberListResponse], error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *ProjectMemberServiceHandler) Get(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectMemberGetRequest]) (*connect.Response[apiv1.ProjectMemberResponse], error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *ProjectMemberServiceHandler) Update(_a0 context.Context, _a1 *connect.Request[apiv1.ProjectMemberUpdateRequest]) (*connect.Response[apiv1.ProjectMemberResponse], error) {
	ret := _m.Called(_a0, _a1)
...
// NewProjectMemberServiceHandler creates a new instance of ProjectMemberServiceHandler. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewProjectMemberServiceHandler(t interface {
	mock.TestingT
	Cleanup(func())
}) *ProjectMemberServiceHandler {
	mock := &ProjectMemberServiceHandler{}
	mock.Mock.Test(t)
