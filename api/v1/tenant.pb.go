...
var file_v1_tenant_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xe5, 0x01, 0x0a, 0x06, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x12, 0x1c, 0x0a,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x73, 0x0a, 0x11, 0x54,
	...
	,
	...
	0x61, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x06, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x17, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x6e, 0x61, 0x6e,
	0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2f, 0x0a, 0x03, 0x47, 0x65, 0x74,
	0x12, 0x14, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x47, 0x65, 0x74, 0x52,
	...
	0x65, 0x72, 0x64, 0x61, 0x74, 0x61, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76,
...
var file_v1_tenant_proto_goTypes = []interface{}{
	...
	(*TenantFindRequest)(nil),    // 5: v1.TenantFindRequest
	(*TenantResponse)(nil),       // 6: v1.TenantResponse
	(*TenantListResponse)(nil),   // 7: v1.TenantListResponse
	(*Meta)(nil),                 // 8: v1.Meta
	(*QuotaSet)(nil),             // 9: v1.QuotaSet
	(*IAMConfig)(nil),            // 10: v1.IAMConfig
	(*wrappers.StringValue)(nil), // 11: google.protobuf.StringValue
}
var file_v1_tenant_proto_depIdxs = []int32{
	8,  // 0: v1.Tenant.meta:type_name -> v1.Meta
	9,  // 1: v1.Tenant.default_quotas:type_name -> v1.QuotaSet
	9,  // 2: v1.Tenant.quotas:type_name -> v1.QuotaSet
	10, // 3: v1.Tenant.iam_config:type_name -> v1.IAMConfig
	0,  // 4: v1.TenantCreateRequest.tenant:type_name -> v1.Tenant
	0,  // 5: v1.TenantUpdateRequest.tenant:type_name -> v1.Tenant
	11, // 6: v1.TenantFindRequest.id:type_name -> google.protobuf.StringValue
	11, // 7: v1.TenantFindRequest.name:type_name -> google.protobuf.StringValue
	0,  // 8: v1.TenantResponse.tenant:type_name -> v1.Tenant
	0,  // 9: v1.TenantListResponse.tenants:type_name -> v1.Tenant
	1,  // 10: v1.TenantService.Create:input_type -> v1.TenantCreateRequest
	2,  // 11: v1.TenantService.Update:input_type -> v1.TenantUpdateRequest
	3,  // 12: v1.TenantService.Delete:input_type -> v1.TenantDeleteRequest
	4,  // 13: v1.TenantService.Get:input_type -> v1.TenantGetRequest
	5,  // 14: v1.TenantService.Find:input_type -> v1.TenantFindRequest
	6,  // 15: v1.TenantService.Create:output_type -> v1.TenantResponse
	6,  // 16: v1.TenantService.Update:output_type -> v1.TenantResponse
	6,  // 17: v1.TenantService.Delete:output_type -> v1.TenantResponse
	6,  // 18: v1.TenantService.Get:output_type -> v1.TenantResponse
	7,  // 19: v1.TenantService.Find:output_type -> v1.TenantListResponse
