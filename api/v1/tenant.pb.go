...
type ContactDetails struct {
	...
	Address *postaladdress.PostalAddress `protobuf:"bytes,3,opt,name=address,proto3" json:"address,omitempty"`
	// Avatar URL
...
func (x *ContactDetails) GetAddress() *postaladdress.PostalAddress {
	if x != nil {
		return x.Address
	}
	return nil
